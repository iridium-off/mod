...
public class ItemAxeMod extends ItemTool implements IHasModel
{
    ...
    private static final Set<Block> EFFECTIVE_ON = Sets.newHashSet(BlockInit.IRIDIUM_BLOCK, Blocks.PLANKS, Blocks.BOOKSHELF, Blocks.LOG, Blocks.LOG2, Blocks.CHEST, Blocks.PUMPKIN, Blocks.LIT_PUMPKIN, Blocks.MELON_BLOCK, Blocks.LADDER, Blocks.WOODEN_BUTTON, Blocks.WOODEN_PRESSURE_PLATE);

    public ItemAxeMod(ToolMaterial material, String name, CreativeTabs tabs)
    {
